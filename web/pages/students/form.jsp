            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <form id="form_validation" name="student-form" class="m-t-30" novalidate="novalidate">
                        ...
                        <button class="btn btn-success waves-effect m-r-5" type="button" onclick="doSubmit(event,this)">
                            <i class="material-icons">save</i><span>Lưu</span>
                        </button>
                        <button class="btn bg-orange waves-effect" type="button" onclick="doReset()"><i class="material-icons">refresh</i> <span>Reset</span></button>
                    </form>
                </div>
            </div>
